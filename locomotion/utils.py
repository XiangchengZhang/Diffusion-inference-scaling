...
def get_args(arg_list=None):
    ...
    parser.add_argument("--env", default="walker2d-medium-replay-v2") # OpenAI gym environment name
    parser.add_argument("--seed", default=1, type=int)             # Sets Gym, PyTorch and Numpy seeds
    parser.add_argument("--expid", default="groundtruth_CEP", type=str)    # 
...
def bandit_get_args():
    ...
    parser.add_argument("--expid", default="contrastive_groundtruth", type=str)    # 
    parser.add_argument("--device", default="cuda", type=str)      #
    parser.add_argument("--save_model", default=1, type=int)       #
    parser.add_argument('--debug', type=int, default=0)
    parser.add_argument('--alpha', type=float, default=3.0)        # beta parameter in the paper, use alpha because of legacy
